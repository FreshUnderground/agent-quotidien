# Briefs créateur — visuels marketing réalistes

**Date :** 2026-06-29

## Comment utiliser ce document

Les fichiers `.png` auto-générés sont des **ébauches** (texte + charte). Pour un rendu **marketing professionnel**, suivez ces briefs dans **Canva**, **Photoshop** ou avec une **photo terrain**.
...
**Photo produit :**
**URL image (catalogue) :** https://uzaapp.com/uploads/produits/1782719758_182b796df5450596.jpg
(Capture ou import directe dans Canva)

**Texte sur le visuel :** Samsung S10e — 110 $
...
- Bandeau bas orange `orange #E85D2C` : nom + **prix 110 $** en gros blanc
...
**Photo produit :**
**URL image (catalogue) :** https://uzaapp.com/uploads/produits/1782719711_94df7b819cc0bbaf.jpg
(Capture ou import directe dans Canva)

**Texte sur le visuel :** Pixel 6 — 133 $ $

**Mise en page recommandée (Canva / Photoshop) :**
- Zone haute (60 %) : **photo réelle du produit** sur fond blanc ou dégradé léger orange pâle
- Bandeau bas orange `orange #E85D2C` : nom + **prix 133 $** en gros blanc
- Coin haut droit : accent teal #1A8A8A (comme l'icône UZAAPP)
- Bas : « Commandez sur **uzaapp.com** » + logo UZAAPP
- **Ne pas** utiliser d'IA pour générer le produit — photo catalogue ou prise studio
...
**Texte sur le visuel :** Entre saisons · Qualité Fairtrade

**Sujet / angle :** Silhouette montagne Rwenzori + grains de café stylisés
...
**Si pas de photo dispo aujourd'hui :** graphique charte (bleu #5BA3D9, vert #4CAF50, rouge #E53935, brun #5D4037) + texte ci-dessus — **sans personnes IA**.
...
**Texte sur le visuel :** Cybersécurité & conformité numérique
...
**Charte :** teal #268FA5, noir, blanc — monochrome strict
...
- [ ] Logo marque visible
- [ ] Lien site en légende : kawakanzururu.com, uzaapp.com, investee-group.com, imsystem.investee-group.com

*Ébauches auto : `output/images/2026-06-29/*.png`*
